...
--
-- Host: 127.0.0.1
-- Creato il: Mag 21, 2024 alle 16:54
...
CREATE TABLE `partita` (
  ...
  `squadra1` varchar(30) DEFAULT NULL,
  `squadra2` varchar(30) DEFAULT NULL
...
INSERT INTO `partita` (`ID_Partita`, `squadra1`, `squadra2`) VALUES
...
CREATE TABLE `punti` (
  ...
  `ID_Partita` int(11) NOT NULL,
  `punti` int(1) DEFAULT NULL,
  `squadra` int(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `punti` (`ID_Punti`, `ID_Partita`, `punti`, `squadra`) VALUES
(1, 1, 1, 1),
(2, 1, 1, 2),
(3, 1, 1, 1),
(4, 1, 1, 1),
...
--
ALTER TABLE `punti`
  MODIFY `ID_Punti` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2670;
COMMIT;
